...
So I'm taking an informal poll on that, too, and for the first time I'll be using the task feature I wrote years ago (![:V](/styles/sv_smiles/xenforo/emot-v.gif ":V    :V")). So:
